...
export const figmaBrandLogos = ["Logo", "Logo", "Logo", "Logo"];
...
export const figmaTools = ["Slack", "Zapier", "Notion", "Figma", "Drive", "Dropbox", "GitHub", "Linear"];

export const figmaPricingPlans = [
    {
        slug: "starter",
        name: "Starter",
        price: "$199",
...
export const figmaPricingFeatureGroups = [
    {
        title: "Main Features",
        rows: [
...
export const figmaPaymentMethods = [
    {
        name: "M-Pesa",
        summary: "Fast local mobile payments for deposits, milestone payments, and final balances.",
        detail: "We share the payment number and confirmation steps once your scope is approved.",
    },
    {
        name: "Bank Transfer",
        summary: "A straightforward option for invoice-based payments and larger project settlements.",
        detail: "Bank details are shared directly on your invoice so accounting stays clear and traceable.",
    },
];

export const figmaFaqs = [
    {
...
export const figmaContactDetails = [
    { label: "Call us", value: "+254706830730" },
    { label: "Email us", value: "enquiries@foxtechsolution.com" },
    { label: "Address", value: "Nairobi, Kenya" },
];

const buildLongStory = ({ titleTopic, heroProblem, pivotAction, resultShift, teamLesson }) =>
    [
        `The version you see now was not born from a neat strategy workshop. It came from one of those weeks where everyone looked busy, everyone was trying hard, and still, by Friday evening, we knew we had not done our best work. That was our reality while working on ${titleTopic}. We had talent, we had energy, but we were not moving in a calm, reliable way.`,
        `I remember one client call that really stayed with us. The client was polite, but their confusion was obvious: "We can see effort, but we still do not know what to expect next." That sentence stung because it was true. Internally, we understood pieces of the plan, but we had not made the full picture visible to the people who trusted us with their brand.`,
        `When we slowed down and looked honestly, the root issue was simple: ${heroProblem}. The problem showed up in tiny moments. A designer would interpret a brief one way, a developer another way, and by the time both versions met, we had already lost time. Nobody was slacking. We were just relying too much on assumptions.`,
        `So instead of blaming people, we audited our working week. We tracked where tasks got stuck, where messages caused confusion, and where we kept revisiting decisions that should have been settled once. That exercise was humbling. It showed us that what we called "normal pressure" was often preventable friction.`,
        `One painful pattern was context switching. In one afternoon, someone could jump from client feedback to layout revisions to internal approvals to emergency bug fixes. By evening, they were exhausted, but the truly important work remained half-done. We realized we were rewarding visible busyness more than meaningful progress.`,
        `Another pattern was unclear ownership. Some tasks sat in the middle, where everyone thought someone else would finalize them. Those gaps were small, but they created delayed decisions, uneven quality, and stress right before deadlines. Once we saw this, we stopped pretending we needed a fancier tool. We needed cleaner habits.`,
        `Our turning point was ${pivotAction}. Nothing dramatic. No big rebrand of our process. Just clear rules we could follow even on hectic days. We wrote them in plain language and kept them visible. If a rule did not survive a busy Tuesday, it was not a good rule.`,
        `We also introduced short check-ins that focused on blockers instead of status theater. No long speeches, no performative updates, just: what is moving, what is stuck, and what needs a decision now. That one shift improved trust inside the team. People felt safer raising concerns early, before they became expensive problems.`,
        `By week three, we noticed real changes. Feedback loops got shorter. Handoffs became clearer. Client updates were easier to write because we had fewer loose ends to explain. Most importantly, the team looked less tense. People still worked hard, but the work felt organized instead of chaotic.`,
        `The quality jump was not magic. It came from fewer hidden decisions. When priorities were explicit, everyone could focus deeper. Creative work improved because designers were not spending half their energy decoding ambiguity. Technical work improved because developers were not patching misunderstandings at the last minute.`,
        `Clients felt the difference too. Conversations became less defensive and more collaborative. Instead of trying to justify delays, we could explain tradeoffs early and propose clear options. That changed the tone of projects. We were no longer reacting to pressure; we were managing it with the client, not around them.`,
        `Over time, we saw the bigger impact: ${resultShift}. The process was still human and imperfect, but it became dependable. We stopped measuring success by heroic last-minute saves and started measuring it by consistency, quality, and client confidence.`,
        `There were still rough weeks. We are a real team, not a machine. Deadlines shifted, unexpected requests landed, and sometimes old habits returned. But now we had a shared baseline. When things drifted, we could reset quickly without blame.`,
        `One lesson we learned the hard way is that leadership tone matters. If leaders create urgency for everything, teams eventually treat nothing with proper focus. We had to model calm prioritization ourselves, or the new system would collapse under mixed signals.`,
        `Another lesson was emotional, not technical. People do better work when they feel respected and clear about expectations. Humanizing workflow is not only about empathy language; it is about building structures that reduce needless stress and let people do their best thinking.`,
        `Looking back, the proudest outcome is not just better delivery metrics. It is that our team became steadier. We can now take on complex work without losing our center. That reliability helps clients trust us and helps our own people stay healthy while doing ambitious work.`,
        `Today, whenever we revisit ${titleTopic}, we keep coming back to what worked: clearer priorities, fewer assumptions, and more honest communication. Tools can help, but they cannot replace discipline and shared understanding.`,
        `If we had to reduce everything to one line, it would be this: ${teamLesson}. Real progress usually starts when teams stop chasing perfect systems and start committing to simple practices they can sustain every week.`,
    ].join("\n\n");

export const figmaBlogPosts = [
    {
        title: "5 Ways to Boost Your Productivity",
        excerpt: "After losing two client deadlines in one month, we audited our workflow and cut it down to five non-negotiables: daily priorities, focused work blocks, reusable templates, meeting limits, and end-of-day reviews. Within three weeks, the team was shipping faster with less stress.",
        story: buildLongStory({
            titleTopic: "productivity",
            heroProblem: "too much effort was being spent reacting to urgent tasks instead of finishing high-impact work",
            pivotAction: "adopting five clear operating rules and tracking them daily",
            resultShift: "delivery consistency improved, missed deadlines dropped, and workdays became calmer and more intentional",
            teamLesson: "productivity grows when teams remove friction first, then optimize speed second",
        }),
        imageClass: "kg-fig-blog-media--1",
    },
    {
        title: "How to build a cleaner service page",
        excerpt: "One client had traffic but very few inquiries. We rebuilt their service page around a clear promise, a simple process, and visible proof. Visitors stayed longer and finally understood what to do next, which led to a steady rise in qualified leads.",
        story: buildLongStory({
            titleTopic: "service page clarity",
            heroProblem: "the page mixed too many ideas at once, so visitors could not quickly understand the offer",
            pivotAction: "restructuring the page into a simple promise, proof section, and single call-to-action flow",
            resultShift: "visitor comprehension improved, bounce behavior reduced, and qualified inquiries increased",
            teamLesson: "clean structure is a conversion strategy, not just a design preference",
        }),
        imageClass: "kg-fig-blog-media--2",
    },
    {
        title: "Why a softer interface can feel more premium",
        excerpt: "A crowded layout made a great business look cheap online. By softening contrast, adding breathing room, and reducing visual noise, the same content started to feel high-end. Clients began describing the brand as more trustworthy and professional.",
        story: buildLongStory({
            titleTopic: "premium interface design",
            heroProblem: "visual intensity was overwhelming users and weakening trust in an otherwise strong brand",
            pivotAction: "using calmer spacing, gentler contrast, and cleaner typography hierarchy",
            resultShift: "perceived quality improved, trust signals strengthened, and users engaged more confidently",
            teamLesson: "premium experiences are usually built through restraint, not decoration",
        }),
        imageClass: "kg-fig-blog-media--3",
    },
    {
        title: "How to organize your case studies better",
        excerpt: "Most case studies stop at screenshots. We switched to a story format: challenge, decisions, implementation, and measurable outcome. Prospects could quickly see relevance to their own business, making sales calls shorter and more focused.",
        story: buildLongStory({
            titleTopic: "case study structure",
            heroProblem: "project showcases highlighted visuals but failed to explain business outcomes",
            pivotAction: "moving every case study to a challenge-decision-outcome storytelling model",
            resultShift: "prospects connected faster with the work and sales conversations became more strategic",
            teamLesson: "evidence becomes persuasive when people can follow the story behind the result",
        }),
        imageClass: "kg-fig-blog-media--4",
    },
    {
        title: "Simple systems that help creative teams launch faster",
        excerpt: "Our designers were reinventing layouts every week. We introduced lightweight systems for briefs, section patterns, and handoff checklists. Launches became more predictable, and the team spent more time on quality thinking instead of repetitive setup work.",
        story: buildLongStory({
            titleTopic: "creative launch systems",
            heroProblem: "repetitive setup work was consuming energy that should have gone into high-value design decisions",
            pivotAction: "standardizing briefs, reusable page patterns, and handoff checklists",
            resultShift: "launch cycles shortened and quality decisions moved earlier in the process",
            teamLesson: "simple systems free creative teams to focus on originality where it counts",
        }),
        imageClass: "kg-fig-blog-media--5",
    },
    {
        title: "Building a blog that feels connected to the product",
        excerpt: "A blog should not feel like a separate website. We aligned typography, tone, and page structure with the core product experience, so readers moved naturally from articles to service pages without friction. Engagement and conversions both improved.",
        story: buildLongStory({
            titleTopic: "product-connected blogging",
            heroProblem: "content pages looked disconnected from the core product journey and weakened conversion flow",
            pivotAction: "unifying blog design language, narrative tone, and pathway links into product pages",
            resultShift: "session continuity improved and article readers converted more often into service inquiries",
            teamLesson: "content performs best when it feels like a natural extension of the product experience",
        }),
        imageClass: "kg-fig-blog-media--6",
    },
    {
        title: "What makes a services page easier to trust?",
        excerpt: "Trust is built in small moments. We improved one services page with clearer section rhythm, client proof, and direct language about outcomes. Visitors stopped bouncing as quickly, and inquiries became more specific and ready to buy.",
        story: buildLongStory({
            titleTopic: "service-page trust building",
            heroProblem: "users were unsure whether the offer was credible enough to justify contacting the team",
            pivotAction: "adding clear proof, outcome-focused messaging, and better narrative rhythm across sections",
            resultShift: "visitor trust indicators rose and inquiry quality became noticeably stronger",
            teamLesson: "trust is designed through consistency, specificity, and transparent proof",
        }),
        imageClass: "kg-fig-blog-media--1",
    },
    {
        title: "How to make case studies feel more editorial",
        excerpt: "Instead of presenting project work as a gallery, we edited each story like an article with narrative flow, context, and selective visuals. The result felt more premium and thoughtful, helping the brand stand out from template-heavy competitors.",
        story: buildLongStory({
            titleTopic: "editorial case study storytelling",
            heroProblem: "case studies looked generic and failed to communicate depth of thinking",
            pivotAction: "editing each case with a publication-style narrative and intentional visual pacing",
            resultShift: "brand authority improved and project stories became more memorable to decision-makers",
            teamLesson: "editorial discipline turns project archives into persuasive thought leadership",
        }),
        imageClass: "kg-fig-blog-media--2",
    },
    {
        title: "A simple checklist for cleaner page launches",
        excerpt: "We created a pre-launch checklist covering content clarity, visual consistency, CTA alignment, mobile polish, and final QA. Teams using it reported smoother launches, fewer urgent fixes, and stronger confidence in what went live.",
        story: buildLongStory({
            titleTopic: "clean page launch operations",
            heroProblem: "small launch misses were creating post-release fixes and reducing team confidence",
            pivotAction: "implementing a lightweight checklist for clarity, consistency, responsiveness, and QA",
            resultShift: "launches became smoother, emergency fixes dropped, and release confidence increased",
            teamLesson: "checklists protect quality when timelines are tight and stakes are high",
        }),
        imageClass: "kg-fig-blog-media--3",
    },
];

export const homeGoalCards = [
    {
...
export const resultsProjects = [
    {
        title: "The School Data Verification System for the Ministry of Education",
        imageClass: "kg-results-thumb--1",
        challenge: "Visitors were landing on the site but leaving before understanding the core services.",
        work: "We rewrote the page flow around one clear value proposition, added trust-building proof blocks, and simplified navigation.",
        outcome: "Lead form starts improved within the first month, and the team reported fewer repetitive pre-sales questions.",
    },
    {
        title: "Elimu Trees for the Ministry of Education",
        imageClass: "kg-results-thumb--2",
        challenge: "Property listings looked busy and users struggled to compare options quickly on mobile.",
        work: "We introduced cleaner listing cards, tighter filter hierarchy, and a more focused mobile browsing path.",
        outcome: "Session duration increased and inquiry quality improved because users reached the right listings faster.",
    },
    {
        title: "Website Design in Kenya for Fashion Guru",
        imageClass: "kg-results-thumb--3",
        challenge: "The brand looked strong on social media but the website felt dated and disconnected.",
        work: "We aligned site visuals with the brand voice, rebuilt product storytelling, and improved checkout clarity.",
        outcome: "The business saw stronger customer confidence online and a smoother path from discovery to purchase.",
    },
    {
        title: "Website Design in Kenya for TGS Abroad",
        imageClass: "kg-results-thumb--4",
        challenge: "Prospective students could not easily follow the process from inquiry to application.",
        work: "We mapped the journey step-by-step, clarified requirements, and added targeted call-to-action sections.",
        outcome: "Application-related inquiries became more complete, reducing back-and-forth and speeding admissions support.",
    },
    {
        title: "Website Design in Kenya for Listos Linguistas",
        imageClass: "kg-results-thumb--5",
        challenge: "Service offerings were buried in long text, making it hard for users to pick the right option.",
        work: "We broke content into scannable service modules and added clearer decision cues for each audience type.",
        outcome: "Users moved through service pages with less friction and contacted the team with better context.",
    },
    {
        title: "Website Design in Kenya for Branjels Healthcare",
        imageClass: "kg-results-thumb--6",
        challenge: "Patients needed quick answers, but key information was scattered across multiple sections.",
        work: "We reorganized care information, highlighted priority actions, and streamlined contact pathways.",
        outcome: "The site became easier to trust, and patient inquiries arrived with clearer intent.",
    },
    {
        title: "Website Design in Kenya for Hello Hair Oils",
        imageClass: "kg-results-thumb--7",
        challenge: "Product benefits were not obvious, which hurt confidence for first-time buyers.",
        work: "We tightened product messaging, introduced routine-based recommendations, and improved social-proof placement.",
        outcome: "Returning customer interest improved and first-time buyers had an easier decision path.",
    },
    {
        title: "Website Design in Kenya for Lusamik Equipments",
        imageClass: "kg-results-thumb--8",
        challenge: "B2B buyers needed technical details quickly, but pages were too generic for serious procurement.",
        work: "We added structured specification sections, clearer category architecture, and stronger quote-request prompts.",
        outcome: "Sales conversations started with better-qualified buyers and clearer purchase requirements.",
    },
    {
        title: "Website Design in Kenya for Just Karz Kenya",
        imageClass: "kg-results-thumb--9",
        challenge: "Vehicle shoppers had interest, but trust barriers slowed inquiries and booking actions.",
        work: "We rebuilt listing detail pages with transparent information, better media order, and financing clarity.",
        outcome: "Inquiry confidence improved, especially for users visiting on mobile before contacting the team.",
    },
];
...
export const advertiseSolutions = [
...
export const advertiseOutcomes = [
    {
...
export const advertiseArticles = [
    {
...
export const domainHeroBenefits = [
    "Matching Domain Email",
    "FREE SSL Certificate",
    "Unmatched 24/7 support",
];

export const domainPriceRows = [
...
export const logoPortfolioSamples = [
...
export const socialPortfolioSamples = [
...
export const fullBrandingSections = [
    {
...
export const customWebsiteSamples = [
...
export const customWebsiteBenefits = [
...
export const customWebsiteTips = [
    {
...
export const customWebsiteFaqs = [
    {
...
export const ecommerceAchievements = [
...
export const hostingLearnPosts = [
    {
...
export const pageMap = {
    ...
    "/payment": {
        kind: "payment",
        title: "Payment | Fox Tech Solutions",
        heading: "Complete your payment",
        summary: "Choose your plan, review the payment method, and follow the payment instructions below.",
    },
    "/about": {
        kind: "about",
